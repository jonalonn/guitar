  ...
  */
  ...
  int notes[]={NOTE_F4,NOTE_G4,NOTE_E4,NOTE_C4}; // C-Major scale
  ...
  int stringTouched[] ={false,false,false,false};
  ...
  void loop() {    
    ...
    for (int i = 0; i < NUM_OF_KEYS; ++i) {
        ...
        if(c > CAP_THRESHOLD) {
          stringTouched[i]=true;
          Serial.println(stringTouched[0]);
          Serial.println(stringTouched[1]);
          Serial.println(stringTouched[2]);
          Serial.println(stringTouched[3]);
          Serial.println(" ");
